				...
				if(skillType=="header") then
					...
					if(atsw_multicount==true) then
						if ( numAvailable == 0 ) then
							--skillButton:SetText(" "..skillName);
							skillButton:SetText(" ("..skillType..") "..skillName); --McP added text difficulty indicator
							else
							--skillButton:SetText(" "..skillName.." ["..numAvailable.."]");
							skillButton:SetText(" ("..skillType..") "..skillName.." ["..numAvailable.."]"); --McP added text difficulty indicator
						end
						else
